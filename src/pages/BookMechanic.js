  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <div className="flex-grow flex flex-col items-center justify-center bg-green-100 p-6 rounded-lg shadow-lg">
        <h2 className="text-2xl font-bold mb-6 text-center">Book an Electric Vehicle Mechanic</h2>
        <form onSubmit={handleSearch} className="flex items-center justify-center space-x-4 mb-6 w-full">
          <input
            type="text"
            placeholder="Enter location of EV Charging Station"
            value={location}
            ...
            required
          />
          <button type="submit" className="bg-green-500 text-white font-bold py-2 px-4 rounded-md hover:bg-green-600">
            Find Mechanics
          </button>
        </form>
      ...
      {/* Define your Footer component or remove this line if unnecessary */}
      {/* <Footer /> */}
    </div>
  );
};
