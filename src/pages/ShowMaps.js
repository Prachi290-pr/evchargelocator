  ...
  return (
    <div className="bg-white rounded-xl shadow-xl p-6 transition duration-300 transform hover:-translate-y-2 hover:shadow-2xl flex flex-col justify-between">
      <div>
        ...
        <p className="font-medium text-blue-600 mb-4">Availability : {station.timeSlot}</p>
      </div>
      <div className="mt-4">
        <button
          className="bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-lg shadow-md text-lg"
...
const EVStationList = () => {
  ...
  return (
    <div>
    <div className="min-h-screen pt-16 bg-gradient-to-b from-green-200 to-green-400">
      <h2 className="text-4xl font-bold text-center mb-10">Find EV Charging Stations</h2>
      <form onSubmit={handleSearch} className="flex justify-center items-center mb-10">
        <input
          ...
          className="shadow-lg p-3 rounded-lg text-lg mr-4 w-72"
          required
        />
        <button type="submit" className="bg-blue-500 hover:bg-blue-600 text-white py-3 px-6 rounded-lg shadow-lg text-lg">
          Search Stations
        </button>
      </form>
